...
urlpatterns = [
    ...
    path('api/category/', views.productCatagoryList.as_view()),
    path('api/category/<int:id>/', views.productCatagoryList.as_view()),
    # path('api/category/<int:id>/<slug:slug>/', views.productCatagoryList.as_view(), name='delete'),
